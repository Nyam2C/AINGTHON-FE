  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-black">
      <div className="relative mx-auto h-[844px] w-[390px] bg-white">
        ...
        <p className="absolute bottom-[60px] left-1/2 -translate-x-1/2 whitespace-nowrap text-center font-inter text-[20px] font-bold leading-[28px] text-blue-500 motion-safe:animate-fade-in-up-text-2 motion-reduce:animate-none">
          대학생 개발자를 위한
          <br />
          멘토링 커뮤니티
        </p>
