  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'fade-in-up-200': 'fadeInUp 500ms ease-out 200ms both',
        'fade-in-up-400': 'fadeInUp 500ms ease-out 400ms both',
        'fade-in': 'fadeIn 300ms ease-out both',
        'pop-in': 'popIn 600ms cubic-bezier(0.34, 1.56, 0.64, 1) both',
